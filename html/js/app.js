...
function showBlur() {
    $.post('https://qbr-inventory/showBlur');
}
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://qbr-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://qbr-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://qbr-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://qbr-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://qbr-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://qbr-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://qbr-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://qbr-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://qbr-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://qbr-inventory/CloseInventory", JSON.stringify({}));
