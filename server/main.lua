...
exports['qbr-core']:AddCommand("resetinv", "Reset Inventory (Admin Only)", {{name="type", help="stash/trunk"},{name="id/plate", help="ID of stash or license plate"}}, true, function(source, args)
